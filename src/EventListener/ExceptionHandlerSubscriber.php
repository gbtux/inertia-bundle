...
use Gbtux\InertiaBundle\Exception\InvalidFormException;
use Gbtux\InertiaBundle\Service\RoutingHistory;
...
{
    public function __construct(private RoutingHistory $routingHistory)
    {}
