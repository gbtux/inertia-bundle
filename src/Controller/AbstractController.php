...
namespace Gbtux\InertiaBundle\Controller;

use Gbtux\InertiaBundle\EventListener\Form\CheckFormValidationStateSubscriber;
...
class AbstractController extends FrameworkBundleAbstractController
{
    /**
